...
folder_path = r"C:\Users\anthony.asaad\OneDrive - Arup\Projects\EG" #complete path eg. "C:\Users\XXXXX\Desktop\folder_name"
file_to_check = "282442-ADC-DE-PWD-DWG-STR0-00003.pdf"     #just the file name eg. "filenames" 
...
def copy_and_rename_files(file_paths_list, parent_folder, file_to_check):
    ...
    for current_path in file_paths_list:
        ...
        parts = first_parent_folder.split('-')
        txt_1 = parts[-2]
        txt_2 = parts[-3]
        txt_3 = parts[-6]
        rev = parts[-1]
        pckg_suffix =  f"Pkg {txt_3}-{txt_1}-{txt_2} Rev {rev}"
        # print(f"{pckg_suffix=}")
